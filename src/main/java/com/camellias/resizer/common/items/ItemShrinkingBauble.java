...
public class ItemShrinkingBauble extends ItemBauble implements IBauble {
	...
	public void onEquipped(ItemStack itemstack, EntityLivingBase player) {
		...
		for (int k = 0; k < 30; ++k) {
			player.world.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL, (player.posX + rand.nextFloat() * player.width * 2.0F) - player.width, player.posY + rand.nextFloat() * player.height, (player.posZ + rand.nextFloat() * player.width * 2.0F) - player.width, d2, d0, d1);
		}
	}
